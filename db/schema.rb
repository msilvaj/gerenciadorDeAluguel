...
ActiveRecord::Schema.define(version: 2020_03_19_192900) do
  ...
  create_table "modeis", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_modeis_on_email", unique: true
    t.index ["reset_password_token"], name: "index_modeis_on_reset_password_token", unique: true
  end
